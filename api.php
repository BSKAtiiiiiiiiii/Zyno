...
case 'upload_music':
    ...
    fn_jsonResponse(['success' => true, 'item' => $item, 'redirect' => '/music.php?view=detail&id=' . $id]);
    break;
...
case 'upload_sticker':
    ...
    fn_jsonResponse(['success' => true, 'item' => $item, 'redirect' => '/stickers.php?view=detail&id=' . $id]);
    break;
...
case 'upload_coding':
    ...
    fn_jsonResponse(['success' => true, 'item' => $item, 'redirect' => '/coding.php?view=detail&id=' . $id]);
    break;
...
case 'upload_theme':
    ...
    fn_jsonResponse(['success' => true, 'item' => $item, 'redirect' => '/themes.php?view=detail&id=' . $id]);
    break;
